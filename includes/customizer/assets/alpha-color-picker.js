...
( function( $ ) {
	...
	let image = 'data:image/png;base64,',
	...
	$.widget( 'a8c.iris', $.a8c.iris, {
		_create: function() {
			...
			if ( typeof this.options.alpha !== 'undefined' && this.options.alpha ) {
				...
				let emptyWidth = ( self.picker.width() - self.controls.square.width() - 20 ),
